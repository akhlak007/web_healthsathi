...
import { GooglePlayDeletionForm } from "@/components/forms/GooglePlayDeletionForm";
  ...
  return (
    <>
      <PageHero
        ...
        subtitle="Submit a request to delete your HealthSathi account and associated personal data. Requests are recorded securely for verification and processing."
      />
      <section className="relative overflow-hidden pb-20">
        <div className="absolute inset-0 bg-mesh-light opacity-45 dark:bg-mesh-dark dark:opacity-35" />
        <div className="container-shell grid gap-8 lg:grid-cols-[0.95fr_1.05fr]">
          <GooglePlayDeletionForm />
          <div className="rounded-[2rem] border border-white/70 bg-white/[0.72] p-6 shadow-premium backdrop-blur-2xl dark:border-white/10 dark:bg-white/[0.08]">
            <h2 className="text-2xl font-semibold text-navy dark:text-white">Deletion request process</h2>
