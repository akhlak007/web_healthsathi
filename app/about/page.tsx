  ...
  return (
    <>
      <PageHero
        ...
        title={contentConfig.about.pageTitle}
        subtitle={contentConfig.about.pageSubtitle}
      />
      <section className="relative overflow-hidden pb-20">
        <div className="absolute inset-0 bg-mesh-light opacity-45 dark:bg-mesh-dark dark:opacity-35" />
        <div className="container-shell grid gap-10 lg:grid-cols-[0.9fr_1.1fr]">
          <div>
            <h2 className="text-3xl font-semibold text-navy dark:text-white">{contentConfig.about.missionTitle}</h2>
